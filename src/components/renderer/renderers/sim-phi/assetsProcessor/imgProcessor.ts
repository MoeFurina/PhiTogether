...
async function imgSplit2(img: ImageBitmap, limitX?: number, limitY?: number): Promise<ImageBitmap[]> {
...
export { imgBlur, imgShader, imgPainter, imgSplit, hex2rgba, rgba2hex, imgSplit2 };